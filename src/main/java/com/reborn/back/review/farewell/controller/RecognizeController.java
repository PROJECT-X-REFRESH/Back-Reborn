...
public class RecognizeController {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "RECOGNIZE_2004", description = "fstep 증가가 완료되었습니다.")
    })
    @PutMapping("/nextday")
    public ApiResponse<Boolean> increaseDate(
        ...
        return ApiResponse.onSuccess(SuccessCode.RECOGNIZE_DATE_SUCCESS, true);
    }
}
